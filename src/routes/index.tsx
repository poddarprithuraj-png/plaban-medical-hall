...
import { DiagnosticBooking } from "@/components/diagnostic-booking";
import primaryLogo from "@/assets/plaban-primary-logo.png";
import iconLogo from "@/assets/plaban-icon-logo.png";
import heroPhoto from "@/assets/ai-pharmacy-hero.jpg";
import detailPhoto from "@/assets/ai-pharmacy-service.jpg";
import shelvesPhoto from "@/assets/ai-pharmacy-shelves.jpg";
import storePhoto from "@/assets/ai-pharmacy-counter.jpg";
import tabletsPhoto from "@/assets/ai-pharmacy-products.jpg";
...
const navigation = [
  ...
  { label: "Diagnostics", href: "#diagnostics", id: "diagnostics" },
...
const gallery = [
  { src: heroPhoto, alt: "AI-generated Indian neighborhood medical hall with stocked medicine racks and a pharmacist at the counter", caption: "The people behind the counter", shape: "large" },
  { src: tabletsPhoto, alt: "AI-generated assortment of tablet strips, syrup bottles and everyday pharmacy products", caption: "The medicine you need", shape: "tall" },
  { src: shelvesPhoto, alt: "AI-generated fully stocked shelves of medicine and personal care products in an Indian pharmacy", caption: "Care in the details", shape: "wide" },
  { src: storePhoto, alt: "AI-generated pharmacist assisting a customer at a pharmacy billing counter", caption: "A neighborhood essential", shape: "tall" },
  { src: detailPhoto, alt: "AI-generated pharmacist assisting a customer with a prescription", caption: "A considered approach", shape: "wide" },
];
const services = [
  ...
  { number: "03", title: "Diagnostics", copy: "Select the tests you need and request a preferred appointment. We’ll confirm availability before your visit." },
  { number: "04", title: "Doctor consultations", copy: "MD physician, endocrinologist and urologist consultations. Call to check availability and appointments." },
          ...
          <div className="site-container grid grid-cols-1 gap-14 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-7 lg:col-start-4"><Reveal><h2 className="editorial-title text-[clamp(2.8rem,5.2vw,5.8rem)]">Good care begins <span className="italic text-olive">with being there.</span></h2></Reveal></div>
             <div className="lg:col-span-3 lg:col-start-4"><Reveal className="max-w-sm"><p className="mt-2 text-base leading-[1.9] text-ink-soft">At Plaban Medical Hall, pharmacy is more than a transaction. It’s a conversation, a little reassurance, and the comfort of seeing someone you know.</p><p className="mt-6 text-base leading-[1.9] text-ink-soft">A neighborhood place for your everyday health needs, grounded in Sorbhog Bazar.</p><div className="mt-9 border-l-2 border-olive pl-5"><p className="editorial-label text-muted-foreground">Your pharmacist in Sorbhog</p><p className="mt-2 font-display text-2xl">Ranit Saha</p></div></Reveal></div>
              <div className="relative lg:col-span-5 lg:col-start-8 lg:row-span-2 lg:-mt-1"><Reveal><div className="relative aspect-[1.12] overflow-hidden rounded-[4px] bg-muted"><motion.img src={detailPhoto} alt="AI-generated pharmacist helping a customer at a pharmacy billing counter; not Plaban Medical Hall staff" width={1400} height={1050} loading="lazy" className="absolute inset-0 h-[115%] w-full object-cover object-[50%_45%]" style={reducedMotion ? {} : { y: storyY }} /></div><p className="editorial-label mt-4 text-muted-foreground">AI-generated illustration · Not the actual store or staff</p></Reveal></div>
